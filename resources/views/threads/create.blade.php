...
<div class="min-h-screen bg-gradient-to-br from-blue-50 to-emerald-50 py-12">
    <div class="max-w-3xl mx-auto px-6">
        <div class="bg-white rounded-3xl shadow-xl p-10">
            <h1 class="text-4xl font-bold text-gray-800 mb-2">Create New Discussion</h1>
            <p class="text-gray-600 mb-8">Share your thoughts with the community</p>
            ...
            <form method="POST" action="{{ route('threads.store') }}">
                ...
                <div class="flex gap-4">
                    ...
                    <button type="submit"
                            class="flex-1 bg-gradient-to-r from-emerald-500 to-blue-600 hover:from-emerald-600 hover:to-blue-700 text-white py-4 rounded-2xl font-semibold text-lg shadow-lg shadow-emerald-500/30 transition">
                        Post Discussion
                    </button>
                </div>
            </form>
